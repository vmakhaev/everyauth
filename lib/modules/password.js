...
everyModule.submodule('password')
  ...
  .extractLoginPassword( function (req, res) {
    var loginField = this.loginFormFieldName();
    var passwordField = this.passwordFormFieldName();
    return [req.body[loginField] || req.query[loginField], req.body[passwordField] || req.query[passwordField]];
  })
